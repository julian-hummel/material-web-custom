...
<md-dialog>
  ...
  <div slot="actions">
    <di-text-button form="form-id">Ok</di-text-button>
  </div>
</md-dialog>
```
...
```html
<md-dialog open>
  <div slot="content">A dialog that is opened by default.</div>
</md-dialog>
```
...
<md-dialog open>
  ...
  <div slot="actions">
    <di-text-button form="form-id" value="cancel">Cancel</di-text-button>
    <di-text-button form="form-id" value="ok">Ok</di-text-button>
  </div>
</md-dialog>
```
...
<md-dialog type="alert">
  ...
  <div slot="actions">
    <di-text-button form="form-id" value="cancel">Cancel</di-text-button>
    <di-text-button form="form-id" value="delete">Delete</di-text-button>
  </div>
</md-dialog>
```
